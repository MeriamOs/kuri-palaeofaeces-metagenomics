...
sourcepredict -s sp_sources_september2025.csv -l sp_labels_september2025.csv \
    -o coproid.kuri.standard2024.june2026.100cutoff.sourcepredict.csv \
    -e coproid.kuri.standard2024.june2026.100cutoff.embedding.csv -t 8 \
    kraken_kuri_june2026_100count_minimizer.csv 
